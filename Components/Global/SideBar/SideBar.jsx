      ...
      <div className="deznav-scroll">
        <ul className="metismenu" id="menu">
          ...
          <li>
            <a className="has-arrow ai-icon" aria-expanded="false">
              ...
              <span style={{ cursor: 'pointer'}}  className="nav-text  ">Profile</span>
            </a>
            <ul aria-expanded="false">
              <li>
                <a
          ...
          <li>
            ...
            >
              ...
              <span style={{ cursor: 'pointer'}} className="nav-text">Shop</span>
            </a>
          </li>
          <li>
            <a
            ...
            >
              ...
              <span style={{ cursor: 'pointer'}} className="nav-text ">Chat</span>
            </a>
          </li>
          {/* <li>
            <a
        ...
        <div className="copyright">
          <p className="fs-14 font-w200">
            <strong className="font-w400">Svashthachain Dashboard <br/></strong>©
            All Rights Reserved
          </p>
          {/* <p className="fs-12">
